...
class data_set(Dataset):
    ...
    def __getitem__(self, item):
        ...
        target = torch.LongTensor(1).random_(args.NUM_CLASSES).squeeze()
        return target, img
...
def train(type='single'):
    ...
    DL = DataLoader(data_set(), batch_size=16, num_workers=8, pin_memory=False)
